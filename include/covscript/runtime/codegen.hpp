#pragma once
#include <covscript/runtime/statement.hpp>
...
namespace cs
{
	...
	class method_import_as final : public method_base
	{
	   ...
	   public:
		...
		var get_namespace(const context_t &, binary_tree<token_base *>::iterator);
	...
	class method_loop final : public method_base
	{
	   public:
		...
		statement_base *
		translate(const context_t &, const std::deque<std::deque<token_base *>> &, const binary_tree<token_base *> &);
	};
